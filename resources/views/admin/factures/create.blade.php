                                        ...
                                        <form class="form" action="{{route('admin.store')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم ولقب الفلاح </label>
                                                            <select id="user" name="user"  class="mdb-select md-form">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="user"  class="mdb-select md-form">
                                                                <option  disabled selected>Choose your option</option>
                                                                @foreach($vannes as $vanne)
                                                                    <option  value="{{$vanne->id}}">{{$vanne->numero_van}} </option>
                                                                @endforeach
                                                            </select>
                                                            @error("prenom")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> العداد القديم </label>
                                                            <input type="number"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">  ديون متخلدة </label>
